...
fixture_system = System(positions=[[0, 0], [1, 0]], velocities=[[0, 0], [0, 1]], masses=[1, 1])
...
def test_trajectory():
    ...
    assert trajectory.positions.shape == (101, 2, 2)  # 101 time steps, 2 bodies, 2D positions
    assert trajectory.velocities.shape == (101, 2, 2) # 101 time steps, 2 bodies, 2D velocities
