    ...
    def create(
        ...
        Args:
            moons_per_planet: List whose *length* gives the number of planets
                ...
                Defaults to ``[0, 1, 4, 1]``.
            M: Planet mass (>1). Sun mass = M**2, moon mass = 1.
            k: Orbital radius spacing ratio (>1). Planet i is at radius k**i.
                Consecutive moon radii also grow by this factor.
        ...
        for i, n_moons in enumerate(moons_per_planet):
            ...
            for j in range(n_moons):
                ...
                r_moon = h * (k ** j)
                # Circular-orbit speed around the planet: v = sqrt(M_planet/r)
