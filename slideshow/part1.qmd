...
:::
::: {.column width="45%"}
![A BBC Micro home computer](https://images.squarespace-cdn.com/content/v1/5bf28ad6b98a7888bf3cdce5/1604526890451-LSGI786ZL2ST1CVLKO3B/BBC+Micro.png?format=1500w)

<span class="image-credit">Image credit: <a href="https://www.tnmoc.org/adopt-artefacts/adopt-a-bbc-micro">The National Museum of Computing</a>.</span>
:::
:::
...
::: {.column width="45%"}
```{=html}
<video controls muted loop playsinline width="100%" aria-label="Single-particle straight-line motion with constant velocity">
  <source src="assets/constant_euler.mp4" type="video/mp4">
  Single-particle straight-line motion with constant velocity.
</video>
```
:::
:::
...
```{=html}
<video controls muted loop playsinline width="100%" aria-label="Sun orbit simulation with Euler integration">
  <source src="assets/sun_euler.mp4" type="video/mp4">
  Sun orbit simulation with Euler integration.
</video>
```
