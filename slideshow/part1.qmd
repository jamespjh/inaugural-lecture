...
Change your velocity toward anything heavy:
    The heavier it is → the more you accelerate
        twice as heavy → twice as much (proportional)
...
::: {.columns}
::: {.column width="55%"}
The code on the slide is not meant to be real, runnable source.
...
::: {.column width="45%"}
```{=html}
<video controls muted loop playsinline width="100%" aria-label="Placeholder video for straight-line motion demo">
  <source src="assets/placeholder.mp4" type="video/mp4">
  Placeholder video for straight-line motion demo.
</video>
```
:::
:::
...
```{=html}
<video controls muted loop playsinline width="100%" aria-label="Placeholder video for gravity demo">
  <source src="assets/placeholder.mp4" type="video/mp4">
  Placeholder video for gravity demo.
</video>
```
