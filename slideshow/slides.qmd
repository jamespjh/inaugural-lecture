...
## Deck navigation
<!--
- Left/right moves between Part one, Part two, and Part three.
- Up/down moves within each Part section stack.
- This pass preserves section mapping; text-trimming comes later.
-->

<!-- COMMENTED_FOR_LIVE_DELIVERY: Overflow text may be commented in a future pass. -->
## Structural note
<!--
