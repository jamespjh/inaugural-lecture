...
::: {}
{{< image-credit
  src="https://dgen.net/0/wp-content/uploads/2013/02/AMEE-bug_300x300_whiteBG.png"
  alt="AMEE logo"
  credit="Gavin Starks et al"
  credit_url="https://dgen.net/0/2017/03/10/the-amee-story-part-one/" >}}
:::
::::
...
## 2.2 Computational science as a political football

{{< image-credit
  src="assets/stored/political_football.png"
  alt="A cartoon illustrating science as a political football."
  credit="Generated with the DALL·E image model, OpenAI, accessed via ChatGPT (April 2026)"
  credit_url="https://chatgpt.com/share/69e76f67-4a50-838c-b795-e36b987493d9" >}}
...
::: {}
{{< image-credit
  src="assets/stored/mrc.png"
  alt="The MRC-IDE codebase from the Imperial College London laboratory."
  credit="Screenshot from Github.com April 2026"
  credit_url="https://github.com/mrc-ide/covid-sim" >}}
::: 
::: {}
{{< image-credit
  src="assets/generated/SIR.svg"
  alt="The SIR compartmental model of epidemiology."
  width="100%" >}}
:::
::::
...
::: {}
{{< image-credit
  src="assets/generated/lecture.svg"
  alt="Illustration of the CI/CD workflow building this lecture" >}}
:::
::::
...
In computational science, we have developed practices to 
enable our workflows to be fully automatically reproducible.
...
::: {}
{{< image-credit 
src="assets/stored/earthquake.png" alt="Illustration of an earthquake damaging only some buildings." >}}
:::
::::
...
{{< image-credit
src="assets/stored/postoffice.jpg"
alt="Protesting sub-postmasters outside the Royal Court of Justice"
credit="Photo by PA Media, accessed via the BBC" 
...
{{< image-credit
src="assets/stored/Turing.jpg"
alt="A photo of the entrance to the Alan Turing Institute, in the British Library"
credit="The Alan Turing Institute"
credit_url="https://www.turing.ac.uk/" >}}
...
## 2.9 The Research Software Engineer

{{< image-credit
src="assets/stored/ScholarAndCraftsman.jpg"
alt="Black and white historical photographs of an
academic and a smith working in a forge"
credit="Beineke Library, used by permission, composed by the Software Sustainability Institute"
credit_url="https://www.software.ac.uk/blog/craftsperson-and-scholar"
width="100%" >}}
...
{{< image-credit
src="assets/generated/science_and_engineering.svg"
...
{{< image-credit
src="assets/stored/epistemologies.png"
...
## 2.19 Service provision as an academic practice

:::: {.two-col}
::: {}
{{< image-credit
src="assets/generated/arc.svg"
