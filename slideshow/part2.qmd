...
{{< image-credit
  ...
  creditlink="https://dgen.net/0/2017/03/10/the-amee-story-part-one/" >}}
:::
::::
...
{{< image-credit
  ...
  creditlink="https://chatgpt.com/share/69e76f67-4a50-838c-b795-e36b987493d9" >}}
...
:::: {.two-col}
::: {}
* Image from the register about Neil's code
::: 
::: {}
Image illustrating a SIR model
:::
::::
...
:::
::: {}
A diagram showing automated deployment for this lecture.
:::
...
:::
::: {}
Image: a link to a city with some buildings fallen down from
an earthquake, and some still standing.
:::
::::
...
Four-part diagram showing the different ways science can touch engineering.
